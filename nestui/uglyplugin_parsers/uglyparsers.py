...
from nestui.Library.parser_examples import p_examples
from ttp import ttp
from jinja2 import Template
import yaml
import json
import jmespath
from nestui.uglyplugin_parsers.HighlighterTEWidget import SyntaxHighlighter
...
class UglyParsingWidget(QtWidgets.QWidget):
    ...
    def setupUi(self):
        self.mode = "Mode"
        self.setWindowTitle("TTP, JMesPAT, Jinja2")
...
if __name__ == "__main__":
    ...
    MainWindow.setWindowTitle("Parsing Multitool")
    MainWindow.show()
